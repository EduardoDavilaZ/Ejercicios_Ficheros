/*Si has desayunado fuerte, te gustan los desafíos y has hecho el ejercicio anterior,
modifícalo para buscar una palabra en todos los ficheros de un directorio. Utiliza fíndfirsty
findnext (busca más información en la ayuda).*/
